...
const Resume = () => {
  const handleClick = () => {
    ...
    window.open(
      "https://drive.google.com/file/d/1sHtn3GneF0F1YN6pN-oaOM1sHOhCi9Tp/view?usp=sharing",
      "_blank"
    );
  };

  return (
    <div id="pulsa" className="pulsa" onClick={handleClick}>
      <button id="cta" className="cta">
        Resume<div className="star a"></div>
